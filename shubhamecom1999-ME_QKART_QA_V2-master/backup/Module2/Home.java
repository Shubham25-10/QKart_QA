...
public class Home {
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            List<WebElement> parentElemnts = driver.findElements(By.xpath("//div[@class='MuiBox-root css-1gjj37g']"));
                ...
                for(WebElement parentElement : parentElemnts){
                        ...
                        if(productTitle.equals(productName)){
                            while (true){
                            WebElement countOfProduct = parentElement.findElement(By.xpath("./div[2]/div[1]/div"));
                            String countText = countOfProduct.getText();
                            int actualCount = Integer.parseInt(countText);
                            if(quantity>actualCount){
                              WebElement plusButton =   parentElement.findElement(By.xpath("./div[2]/div[1]/button[2]"));
                              plusButton.click();
                                Thread.sleep(3000);
                            }else if(quantity < actualCount){
                                 WebElement minusButton =   parentElement.findElement(By.xpath("./div[2]/div[1]/button[1]"));
                              minusButton.click();
                              Thread.sleep(3000);
                            }else if(quantity==actualCount){
                                break;
