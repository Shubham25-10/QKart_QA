...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
             List<WebElement> selectAddress = driver.findElements(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']/div[1]/p"));
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            WebElement errorMessage = driver.findElement(By.xpath("//body/div[@id='root']/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]"));
           String errorText = errorMessage.getText();
           if(errorText.contains("You do not have enough balance in your wallet for this purchase")){
            return true;
           }else{
            return false;
           }
